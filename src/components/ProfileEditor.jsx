...
export default function ProfileEditor() {
  ...
  return (
    <div className="h-full px-3 sm:px-4 py-4 sm:py-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-4 sm:space-y-8">
        <div>
          <div className="text-[#00c8ff] font-medium mb-1 sm:mb-2">Name</div>
          <input
            type="text"
            value={profile.name}
            onChange={handleNameChange}
            className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-sm bg-transparent border-b border-[#1e3a8a] focus:border-[#00c8ff] transition"
            style={{ color: 'white' }}
          />
        </div>
        
        <div>
          <div className="text-[#00c8ff] font-medium mb-1 sm:mb-2">Age</div>
          <input
            type="number"
            value={profile.age}
        ...
        <div className="mt-6 sm:mt-12 pt-4 sm:pt-6 border-t border-[#1e3a8a]">
          <div className="text-center text-[#00c8ff] text-lg sm:text-xl mb-4 sm:mb-6">Profile Summary</div>
